 ...
 * <ul>
 * <li>if the native order is little endian (vast majority of cases), this class simply delegates to the appropriate
 * public API method;</li>
 * <li>if the native order is big endian, it re-implements the serialization code, using reflection to get access to a
