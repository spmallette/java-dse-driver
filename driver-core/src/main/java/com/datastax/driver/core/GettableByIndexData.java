...
public interface GettableByIndexData {
     ...
     * @return the boolean value of the {@code i}th element. If the value is NULL, {@code false} is returned.
     ...
     *
     * @param i the index ({@code 0 <= i < size()}) to retrieve.
     * @return the value of the {@code i}th element as a byte. If the value is NULL, {@code 0} is returned.
     ...
     *
     * @param i the index ({@code 0 <= i < size()}) to retrieve.
     * @return the value of the {@code i}th element as a short. If the value is NULL, {@code 0} is returned.
     ...
     *
     * @param i the index ({@code 0 <= i < size()}) to retrieve.
     * @return the value of the {@code i}th element as an integer. If the value is NULL, {@code 0} is returned.
     ...
     *
     * @param i the index ({@code 0 <= i < size()}) to retrieve.
     * @return the value of the {@code i}th element as a long. If the value is NULL, {@code 0L} is returned.
     ...
     *
     * @param i the index ({@code 0 <= i < size()}) to retrieve.
     * @return the value of the {@code i}th element as a float. If the value is NULL, {@code 0.0f} is returned.
     ...
     *
     * @param i the index ({@code 0 <= i < size()}) to retrieve.
     * @return the value of the {@code i}th element as a double. If the value is NULL, {@code 0.0} is returned.
     ...
     * a CQL {@code NULL} will be mapped to an empty collection (note that Cassandra
     ...
     * ones for built-in types ({@link #getBool(int)}, {@link #getInt(int)}, etc.), or {@link #get(int, Class)} and
     * {@link #get(int, TypeToken)} for custom types.
     *
