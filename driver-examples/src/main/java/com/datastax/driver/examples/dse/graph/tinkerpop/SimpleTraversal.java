 ...
 */
package com.datastax.driver.examples.dse.graph.tinkerpop;
...
/**
 * Demonstrates a simple graph traversal, using the Apache Tinkerpop™ API.
 * <p/>
 * Preconditions:
...
public class SimpleTraversal {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Run a simple traversal, expressed with the Tinkerpop fluent API
